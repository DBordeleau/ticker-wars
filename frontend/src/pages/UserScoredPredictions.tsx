    ...
    <main className="dashboard-shell detail-page">
      ...
      <AnimatedSection delay={0.08}>
        <header className="predictions-header">
          <Text className="predictions-header-eyebrow">Leaderboard Drill-down</Text>
          <Title order={1} className="predictions-header-title">
            {displayUsername} Scored Predictions
          </Title>
          <Text className="predictions-header-lead">
            {formatWindow(window)} leaderboard set for {formatHorizon(horizon)} predictions.
          </Text>
          <Group gap="xs">
